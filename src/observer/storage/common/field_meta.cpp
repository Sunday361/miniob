...
const char *ATTR_TYPE_NAME[] = {"undefined", "chars", "ints", "floats", "dates", "text"};
...
FieldMeta::FieldMeta() : attr_type_(AttrType::UNDEFINED), attr_offset_(-1),
                         attr_len_(0), visible_(false), nullable_(false) {}
