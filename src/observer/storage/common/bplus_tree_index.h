...
public:
  ...
  RC create(const char *file_name, const MultiIndexMeta &index_meta, std::vector<FieldMeta> &field_metas);
  RC open(const char *file_name, const MultiIndexMeta &index_meta, std::vector<FieldMeta> &field_metas);
  RC close();
