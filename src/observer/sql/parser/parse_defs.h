...
//属性值类型
typedef enum { UNDEFINED, CHARS, INTS, FLOATS, DATES, TEXTS, NULLTYPE } AttrType;
...
typedef struct {
  ...
  unsigned char isNullable;       // show whether the attr is allowd nullable , default is false
} AttrInfo;
...
typedef struct {
  ...
  int isUnique;          // default is 0, no unique
} CreateIndex;
...
void create_index_init(
    CreateIndex *create_index, const char *index_name,
    const char *relation_name, const char *attr_name, int isUnique);
